...
import Repositorios.ComunidadFacade;
...
public class ComunidadController implements Serializable {
    ...
    private Comunidad current;
    private DataModel items = null;
    @EJB
    private Repositorios.ComunidadFacade ejbFacade;
    ...
    public Comunidad getSelected() {
        if (current == null) {
            current = new Comunidad();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ComunidadFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Comunidad) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ComunidadCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ComunidadUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ComunidadDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class ComunidadControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Comunidad) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Comunidad.class.getName());
            }
        }

...
import Repositorios.TipoorganismoFacade;
...
@Named("tipoorganismoController")
@SessionScoped
public class TipoorganismoController implements Serializable {

    private Tipoorganismo current;
    private DataModel items = null;
    @EJB
    private Repositorios.TipoorganismoFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public TipoorganismoController() {
    }
    ...
    public Tipoorganismo getTipoorganismo(java.lang.String id) {
    ...
    public static class TipoorganismoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TipoorganismoController controller = (TipoorganismoController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "tipoorganismoController");
